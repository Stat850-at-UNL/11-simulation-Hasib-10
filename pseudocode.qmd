...
![Flowchart for craps game](Flowchart.png)
...
simulate_craps_game <- function() {
  # Input: None
  # Output: A data frame with id(Roll number), roll(total dice roll), outcome
  # Description: Simulates a single game of craps.Take Records each roll including its number, dice total and outcome
}
```
...
summarize_craps_game <- function() {
  # Input: Data frame returned by simulate_craps_game function
  # Output: A sigle row data frame with n_rolls(Total rolls in the game), point(The value of come out roll if a point established otherwise NA), outcome(final results)
  # Description: this function extracts all the value of output.Which summarize the result of simulate_craps_game 
}
```
...
run_craps_simulation <- function(N) {
  ...
  # Output: It has the same output colums as summarize function.
  # Description: Simulates multiple craps game and results their summaries and combine them in a data frame
}
```
